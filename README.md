...
> `https://github.com/<your_github_username>/kickstart.nvim.git` - GOT IT

You likely want to remove `lazy-lock.json` from your fork's `.gitignore` file
too - it's ignored in the kickstart repo to make maintenance easier, but it's
[recommended to track it in version control](https://lazy.folke.io/usage/lockfile). - DONE THAT

#### Clone kickstart.nvim

> [!NOTE]
> If following the recommended step above (i.e., forking the repo), replace
> `nvim-lua` with `leesecurelee` in the commands below

<details><summary> Linux and Mac </summary>

```sh
git clone https://github.com/leesecurelee/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/leesecurelee/kickstart.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/leesecurelee/kickstart.nvim.git "${env:LOCALAPPDATA}\nvim"
```
